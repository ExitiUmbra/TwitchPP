...
TwitchPP::Response<std::string> TwitchPP::call_api(std::string_view url,
...
std::string TwitchPP::get_object_param(std::string_view param_name, std::string_view obj_string, size_t tmp_first_pos, size_t tmp_second_pos) {
    ...
    if (tmp_start_pos != std::string::npos) {
        ...
        try {
            closing_char = TwitchPP::closing_chars.at(opening_char);
        }
...
std::pair<std::string, std::string> TwitchPP::get_first_value(std::string initial_string) {
...
std::string TwitchPP::replace_string(std::string subject, std::string_view search, std::string_view replace) {
...
std::string TwitchPP::vector_to_json(std::vector<std::string>& elements) {
    std::string result {"["};
...
std::vector<std::string> TwitchPP::json_to_vector(std::string_view elements) {
...
std::vector<TwitchPP::VideoSegment> TwitchPP::json_to_segment_vector(std::string_view elements) {
    std::vector<TwitchPP::VideoSegment> result {};
    size_t end_pos {std::string::npos};
